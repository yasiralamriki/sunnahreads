          ...
          <CommandGroup heading='Search Results' className='[&_[cmdk-group-heading]]:!text-amber-300'>
            {filteredContent.map((item) => (
              <CommandItem 
                ...
                className='!bg-transparent hover:!bg-gradient-to-r hover:!bg-amber-100/40 active:!bg-amber-200/50 dark:hover:!bg-amber-900/40  dark:active:!bg-amber-800/50 cursor-pointer'
