...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "books_rels" ADD CONSTRAINT "books_rels_tags_fk" FOREIGN KEY ("tags_id") REFERENCES "public"."tags"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "books_author_idx" ON "books" USING btree ("author_id");
  ...
  CREATE INDEX "books_rels_tags_id_idx" ON "books_rels" USING btree ("tags_id");
